    ...
    companion object {
        val products = listOf(
            Product(
                ...
                images = listOf("ghibli_1.png", "ghibli_2.png"),
                stock = 0,
                reviewCount = 0,
            ),
            Product(
                ...
                description = "스튜디오 지브리 장편 작품 포스터 & 팜플렛이 복귀!\n" +
                            ...
                            "부디 이 기회를 놓치지 마세요.",
                images = listOf("ghibli_3.png", "ghibli_4.png"),
                stock = 0,
                reviewCount = 0,
            ),
            Product(
                ...
                description = "스튜디오 지브리 장편 작품 포스터 & 팜플렛이 복귀!\n" +
                            ...
                            "팜플렛은 극장 개봉시에 발매된 상태 그대로 복귀!\n부디 이 기회를 놓치지 마세요.",
                images = listOf("ghibli_5.png", "ghibli_6.png", "ghibli_7.png"),
                stock = 0,
                reviewCount = 0,
            ),
            Product(
                ...
                images = listOf("ghibli_8.png", "ghibli_9.png", "ghibli_10.png"),
                stock = 0,
                reviewCount = 0,
            ),
            Product(
            ...
            Product(
                ...
                description = "달력의 쓰임에 충실하면서도 유용하게 사용될 수 있도록 만들었습니다.\n" +
                        ...
                        "+한눈에 보이는 공휴일, 대체휴일 표기\n" +
                        "+분위기를 살려주는 감성소품 오케이!",
                images = listOf("marvel_1.jpeg", "marvel_2.jpeg", "marvel_3.jpeg"),
                stock = 0,
                reviewCount = 0,
            ),
            Product(
                ...
                description = "INFINITY SAGA(MARVEL)의 포스터(Movie)입니다.\n" +
                        ...
                        "포스터는 B4사이즈입니다.",
                images = listOf("marvel_4.jpeg", "marvel_5.jpg"),
                stock = 0,
                isBest = true,
                reviewCount = 0,
            ),
            Product(
                ...
                images = listOf("marvel_6.jpeg", "marvel_7.jpg"),
                stock = 0,
                reviewCount = 0,
            ),
            Product(
                ...
                description = "INFINITY SAGA(MARVEL)의 체인징 카드 컬렉션(VOL.1)입니다.\n" +
                        "보는 각도에 따라 그림이 다르게 보입니다.\n" +
                        "전 10종류 중, 랜덤으로 1종류가 들어있습니다.",
                images = listOf("marvel_8.jpeg", "marvel_9.jpg"),
                stock = 0,
                reviewCount = 0,
            ),
            Product(
                ...
                description = "베놈 라스트 댄스의 티셔츠(L사이즈)입니다.\n" +
                        "뒤쪽에도 디자인 있습니다.",
                images = listOf("marvel_10.jpg", "marvel_11.jpeg"),
                stock = 0,
                reviewCount = 0,
            ),
            Product(
                ...
                images = listOf("pixar_1.jpg", "pixar_2.jpeg"),
                stock = 0,
                reviewCount = 0,
            ),
            Product(
            ...
            Product(
                ...
                images = listOf("pixar_6.jpg", "pixar_7.jpeg"),
                stock = 0,
                reviewCount = 0,
            ),
            Product(
                ...
                images = listOf("pixar_8.jpg", "pixar_9.jpeg"),
                stock = 0,
                reviewCount = 0,
            ),
            Product(
