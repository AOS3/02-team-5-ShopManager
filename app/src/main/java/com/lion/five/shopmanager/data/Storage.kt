...
object Storage {
    val products = listOf(
        Product(
            ...
            images = listOf(R.drawable.ghibli_1, R.drawable.ghibli_2),
            stock = 0,
            reviewCount = 0,
        ),
        Product(
            ...
            description = "스튜디오 지브리 장편 작품 포스터 & 팜플렛이 복귀!\n" +
                    ...
                    "부디 이 기회를 놓치지 마세요.",
            images = listOf(R.drawable.ghibli_3, R.drawable.ghibli_4),
            stock = 0,
            reviewCount = 0,
        ),
        Product(
            ...
            description = "스튜디오 지브리 장편 작품 포스터 & 팜플렛이 복귀!\n" +
                    ...
                    "팜플렛은 극장 개봉시에 발매된 상태 그대로 복귀!\n부디 이 기회를 놓치지 마세요.",
            images = listOf(R.drawable.ghibli_5, R.drawable.ghibli_6, R.drawable.ghibli_7),
            stock = 0,
            reviewCount = 0,
        ),
        Product(
            ...
            images = listOf(R.drawable.ghibli_8, R.drawable.ghibli_9, R.drawable.ghibli_10),
            stock = 0,
            reviewCount = 0,
        ),
        Product(
            ...
            images = listOf(R.drawable.ghibli_11, R.drawable.ghibli_12),
            stock = 0,
            isBest = true,
            reviewCount = 0,
        ),
        Product(
            ...
            description = "달력의 쓰임에 충실하면서도 유용하게 사용될 수 있도록 만들었습니다.\n" +
                    ...
                    "+한눈에 보이는 공휴일, 대체휴일 표기\n" +
                    "+분위기를 살려주는 감성소품 오케이!",
            images = listOf(R.drawable.marvel_1, R.drawable.marvel_2, R.drawable.marvel_3),
            stock = 0,
            reviewCount = 0,
        ),
        Product(
            ...
            description = "INFINITY SAGA(MARVEL)의 포스터(Movie)입니다.\n" +
                    ...
                    "포스터는 B4사이즈입니다.",
            images = listOf(R.drawable.marvel_4, R.drawable.marvel_5),
            stock = 0,
            isBest = true,
            reviewCount = 0,
        ),
        Product(
            ...
            images = listOf(R.drawable.marvel_6, R.drawable.marvel_7),
            stock = 0,
            reviewCount = 0,
        ),
        Product(
            ...
            description = "INFINITY SAGA(MARVEL)의 체인징 카드 컬렉션(VOL.1)입니다.\n" +
                    "보는 각도에 따라 그림이 다르게 보입니다.\n" +
                    "전 10종류 중, 랜덤으로 1종류가 들어있습니다.",
            images = listOf(R.drawable.marvel_8, R.drawable.marvel_9),
            stock = 0,
            reviewCount = 0,
        ),
        Product(
            ...
            description = "베놈 라스트 댄스의 티셔츠(L사이즈)입니다.\n" +
                    "뒤쪽에도 디자인 있습니다.",
            images = listOf(R.drawable.marvel_10, R.drawable.marvel_11),
            stock = 0,
            reviewCount = 0,
        ),
        Product(
            ...
            images = listOf(R.drawable.pixar_1, R.drawable.pixar_2),
            stock = 0,
            reviewCount = 0,
        ),
        Product(
            ...
            images = listOf(R.drawable.pixar_3),
            stock = 0,
            reviewCount = 0,
        ),
        Product(
            ...
            images = listOf(R.drawable.pixar_4, R.drawable.pixar_5),
            stock = 0,
            reviewCount = 0,
        ),
        Product(
            ...
            images = listOf(R.drawable.pixar_6, R.drawable.pixar_7),
            stock = 0,
            reviewCount = 0,
        ),
        Product(
            ...
            images = listOf(R.drawable.pixar_8, R.drawable.pixar_9),
            stock = 0,
            reviewCount = 0,
        ),
        Product(
            ...
            images = listOf(R.drawable.disney_1, R.drawable.disney_2),
            stock = 0,
            reviewCount = 0,
        ),
        Product(
            ...
            images = listOf(R.drawable.disney_3, R.drawable.disney_4),
            stock = 0,
            reviewCount = 0,
        ),
        Product(
            ...
            images = listOf(R.drawable.disney_5, R.drawable.disney_6),
            stock = 0,
            reviewCount = 0,
        ),
        Product(
            ...
            images = listOf(R.drawable.disney_7, R.drawable.disney_8),
            stock = 0,
            reviewCount = 0,
        ),
        Product(
            ...
            images = listOf(R.drawable.disney_9, R.drawable.disney_10),
            stock = 0,
            reviewCount = 0,
        ),
        Product(
            ...
            images = listOf(R.drawable.harrypotter_1, R.drawable.harrypotter_2),
            stock = 0,
            reviewCount = 0,
        ),
        Product(
            ...
            images = listOf(R.drawable.harrypotter_3, R.drawable.harrypotter_4),
            stock = 0,
            reviewCount = 0,
        ),
        Product(
            ...
            images = listOf(R.drawable.harrypotter_5, R.drawable.harrypotter_6),
            stock = 0,
            reviewCount = 0,
        ),
        Product(
            ...
            description = "저 파도 너머로 나가자.\n" +
                    ...
                    "바다를 사랑하고 바다의 사랑을 받은 소녀.\n" +
                    "고민하면서도, 자신의 마음의 소리를 믿고 한결같이 나아가는 소녀 모아나의 모습에 용기와 기운을 받을 수 있는, 압권의 노래와 영상으로 보내는 감동의 판타지 어드벤처.",
            images = listOf(R.drawable.harrypotter_7, R.drawable.harrypotter_8),
            stock = 0,
            reviewCount = 0,
        ),
        Product(
            ...
            images = listOf(R.drawable.harrypotter_9, R.drawable.harrypotter_10),
            stock = 0,
            reviewCount = 0,
        ),
        Product(
            ...
            images = listOf(R.drawable.teenieping_1),
            stock = 0,
            reviewCount = 0,
        ),
        Product(
            ...
            images = listOf(R.drawable.teenieping_2),
            stock = 0,
            reviewCount = 0,
        ),
        Product(
            ...
            description = "머리띠처럼 편안하게 착!" +
                    ...
                    "뒷면에 집게가 있어 가볍게 톡!" +
                    "옷에 쉽게 걸 수 있어요~",
            images = listOf(R.drawable.teenieping_3),
            stock = 0,
            reviewCount = 0,
        ),
        Product(
            ...
            images = listOf(R.drawable.teenieping_4),
            stock = 0,
            reviewCount = 0,
        ),
        Product(
            ...
            images = listOf(R.drawable.teenieping_5),
            stock = 0,
            reviewCount = 0,
        )
    )
